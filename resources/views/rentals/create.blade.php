...
<div class="bg-gray-800 shadow-md rounded-lg overflow-hidden p-6">
    ...
    <form action="{{ route('rentals.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="client_name" id="client_name" class="mt-1 block w-full px-3 py-2 border border-gray-600 bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-300" autocomplete="off" required>
            <ul id="client_list" class="hidden"></ul>
        </div>
        <div class="mb-4">
            <label for="start_date" class="block text-gray-400">Start Date</label>
            <input type="date" name="start_date" id="start_date" class="mt-1 block w-full px-3 py-2 border border-gray-600 bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-300" required>
        </div>
        <div class="mb-4">
            <label for="end_date" class="block text-gray-400">End Date</label>
            <input type="date" name="end_date" id="end_date" class="mt-1 block w-full px-3 py-2 border border-gray-600 bg-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-gray-300" required>
        </div>
        <div>
